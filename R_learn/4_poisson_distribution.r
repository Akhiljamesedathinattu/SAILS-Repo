...
cumulative_probability) )plot(table(xdev), type="h", xlab="binomial variable x", ylab="frequency",
...
x = seq(0,14)
pdens = dpois(x,mu)
plot(x,pdens, type="h", col="red", xlab = "Poisson variable x", ylab="Poisson probability", main="Poisson probability distribution (mean = 6)")
